...
export default () => {
  ...
  return (
    <div className="min-vh-100 rounded-3 p-3">
      <div className="bg-gray-200 min-vh-100 rounded-3 p-3">
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center  py-4">
      <div className="d-block mt-4 mb-xl-0">
          <h2 className="mt-4">Lịch khám bệnh</h2>
        </div>
      </div>
            ...
            <div className="justify-content-between align-items-center row">
                <div className="d-md-flex col-lg-12 col-12">
                    <div className="me-2 me-lg-3 fmxw-300 input-group">
                        ...
                        <input 
                              placeholder={userLogin.code=="STAFF"? "Bác sĩ, bệnh nhân":(userLogin.code=="DOCTOR"?"Bệnh nhân":"Bác sĩ")} 
                              type="text" 
      ...
      {
        if(userLogin.code=="PATIENT" && item.patient_id != userLogin.id)
        {
          return false;
        }
        return true;
