...
export default (props) => {
    const { _appointment, setShow, detailReview } = props
    const {  index,id,parent_id,payment_amount, status,date,session_time,cancel_reason,examination_info,service_amount,
                   ...
                   <Card.Body>
                       ...
                       {review == 1 ? 
                            <Row  className="mb-4">
                                    ...
                                    <div style={{height:"1px",backgroundColor:"black",opacity:0.3,width:"50%",marginTop:"10px",marginLeft:"10px"}}>
                                    </div>
                                    <div className="my-2">
