...
export default function Booking(props) {
  ...
  const {parent_id, isBooking, handleCloseShowDetail, 
    patient_fullName, patient_email, patient_id, patient_type, patient_phone} = props
  ...
  const save = ()=>{
    ...
    if(passed)
    {
      ...
      Appointment.reExamine(data).then(result=>{
        ...
        {
          setMessageAlert('Đặt lịch tái khám thành công!')
          setSaveSuccess(true)
          handleVisible()
          window.scrollTo({ top: 0, left: 0, behavior: "auto" })
          setTimeout(()=>{
                        ...
                        <Row>
                            ...
                            <Row className="mb-3">
                                <Form.Group id="name">
                                    ...
                                    <Form.Control value={patient_fullName} disabled
                                    required type="text" />
                                </Form.Group>
                            </Row>
                            </Col>
                            ...
                            <Form.Group id="status">
                                <Form.Label>{patient_type==1 ? "Email":"Số điện thoại"}</Form.Label>
                                <Form.Control value={patient_type==1 ? patient_email:patient_phone} disabled
                                    required type="text" />
                            </Form.Group>
                            </Col>
                        </Row>
